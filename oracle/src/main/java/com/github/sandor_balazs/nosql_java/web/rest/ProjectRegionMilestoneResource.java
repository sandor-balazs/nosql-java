...
public class ProjectRegionMilestoneResource {
    ...
    @RequestMapping(value = "/projectRegionMilestones/{id}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ProjectRegionMilestoneDTO> getProjectRegionMilestone(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/projectRegionMilestones/{id}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteProjectRegionMilestone(@PathVariable Long id) {
