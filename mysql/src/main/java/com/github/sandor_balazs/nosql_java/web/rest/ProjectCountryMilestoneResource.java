...
public class ProjectCountryMilestoneResource {
    ...
    @RequestMapping(value = "/projectCountryMilestones/{id}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ProjectCountryMilestoneDTO> getProjectCountryMilestone(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/projectCountryMilestones/{id}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteProjectCountryMilestone(@PathVariable Long id) {
