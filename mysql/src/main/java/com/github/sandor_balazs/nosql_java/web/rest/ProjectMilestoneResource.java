...
public class ProjectMilestoneResource {
    ...
    @RequestMapping(value = "/projectMilestones/{id}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ProjectMilestoneDTO> getProjectMilestone(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/projectMilestones/{id}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteProjectMilestone(@PathVariable Long id) {
