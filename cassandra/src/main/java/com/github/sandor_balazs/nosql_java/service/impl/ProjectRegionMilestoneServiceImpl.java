...
public class ProjectRegionMilestoneServiceImpl implements ProjectRegionMilestoneService{
    ...
    public ProjectRegionMilestoneDTO findOne(String id) {
        ...
        ProjectRegionMilestone projectRegionMilestone = projectRegionMilestoneRepository.findOne(UUID.fromString(id));
    ...
    public void delete(String id) {
        ...
        projectRegionMilestoneRepository.delete(UUID.fromString(id));
    }
}
